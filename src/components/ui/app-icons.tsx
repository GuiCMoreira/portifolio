...
// Geometria padrão dos ícones (a mesma dos assets WhiteSur): squircle 56×56
// com 4px de margem e raio ~13, dentro de um viewBox 64×64. Os ícones
// desenhados à mão usam este grupo para escalar o desenho ao padrão.
const TILE = { transform: "translate(4 4) scale(0.875)" };
  ...
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <g transform={TILE.transform}>
        <rect width="64" height="64" rx="14.9" fill="url(#fndL)" />
...
export function TerminalMacIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <g transform={TILE.transform}>
        <rect width="64" height="64" rx="14.9" fill="url(#trm)" />
        <rect x="1" y="1" width="62" height="62" rx="13.9" fill="none" stroke="rgba(255,255,255,0.14)" strokeWidth="1.5" />
...
export function NotesIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <g transform={TILE.transform}>
        <rect width="64" height="64" rx="14.9" fill="#ffffff" />
        ...
        <rect x="0.75" y="0.75" width="62.5" height="62.5" rx="14.15" fill="none" stroke="rgba(0,0,0,0.08)" strokeWidth="1.5" />
      </g>
    </svg>
  );
}
...
export function MailIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <g transform={TILE.transform}>
        <rect width="64" height="64" rx="14.9" fill="url(#mml)" />
...
export function GitHubTileIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      <g transform={TILE.transform}>
      <rect width="64" height="64" rx="14.9" fill="#1b1f24" />
      <rect x="1" y="1" width="62" height="62" rx="13.9" fill="none" stroke="rgba(255,255,255,0.12)" strokeWidth="1.5" />
...
export function LinkedInTileIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      <g transform={TILE.transform}>
      <rect width="64" height="64" rx="14.9" fill="#0a66c2" />
...
export function InstagramTileIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <g transform={TILE.transform}>
        <rect width="64" height="64" rx="14.9" fill="url(#igg)" />
